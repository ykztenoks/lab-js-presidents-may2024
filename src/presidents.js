...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce(
    (acc, president) =>
      president.leftOffice
        ? president.leftOffice - president.tookOffice + acc
        : acc,
    0
  );
}
...
function getAgeAtInauguration(presidentsArr) {
  ...
  // presidentsArr.map((presidents) => {
  //   return (presidents.ageAtInauguration =
  //     presidents.tookOffice - presidents.birthYear);
  // });
  // return presidentsArr;

  //3RD SOLUTION
  // const ageAtInaugurationArray = presidentsArr.map((president) => {
  //   const ageAtInauguration = president.tookOffice - president.birthYear;
  //   president.ageAtInauguration = ageAtInauguration;
  //   return president;
  // });
  // return ageAtInaugurationArray;
}
